# F18 — Motor de un miembro por proyecto
...
cambiarle el modelo en su ficha se lo cambiaba en las seis proyectos.
...
proyectos que no lo hayan fijado.
...
proyecto; sin punto, es el motor de su ficha. Click abre el panel lateral
...
El ajuste es del MIEMBRO en el proyecto, no del paso. Si `flutter-expert`
...
Los ajustes viajan en el archivo del proyecto (`memberEngines`), por
