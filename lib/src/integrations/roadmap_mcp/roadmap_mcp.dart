...
/// el repo —se ramifica con el código, se revisa en el PR, la lee cualquiera
/// que abra la carpeta— y la TOMA vive en la base local, porque es lo único
/// que necesita ser atómico y lo único que no es propiedad del código sino
/// del momento.
///
